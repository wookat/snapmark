          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <p className="mt-3 text-center text-sm text-zinc-500 lg:text-left">
                ...
                <button onClick={onSample} className="font-semibold text-blue-600 underline decoration-blue-300 underline-offset-2 transition hover:text-blue-500">try a sample image</button>
              </p>
            </div>
